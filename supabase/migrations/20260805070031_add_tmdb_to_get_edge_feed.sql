-- ============================================================================
-- Fix: get_edge_feed RPC - add tmdb_id, tmdb_title, tmdb_type columns.
--
-- PostgreSQL does not allow CREATE OR REPLACE to change a function's return
-- type. We must DROP the old function first, then recreate it with the new
-- RETURNS TABLE that includes the three TMDB columns.
-- ============================================================================
