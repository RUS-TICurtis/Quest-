          ...
          children: [
            ...
            Row(
              children: [
                _archetypeChip(
                  Icons.brush,
                  userState.archetypes.isNotEmpty
                      ? userState.archetypes.first
                      : 'Creator',
                  AppColors.questBlue,
                ),
                SizedBox(width: 10),
                _archetypeChip(
                  Icons.link,
                  userState.archetypes.length > 1
                      ? userState.archetypes[1]
                      : 'Connector',
            ...
            Wrap(
              ...
              children: [
                ...
                _badge(
                  ...
                  'First Connection',
                  AppColors.emerald,
                  userState.joinedCommunityIds.isNotEmpty,
                ),
                _badge(
                  Icons.emoji_events,
                  'Event Master',
                  AppColors.gold,
                  userState.rsvpdEventIds.isNotEmpty,
                ),
              ],
            ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 4),
                          Text(
                            'Manage communities, attendees, and analytics',
                            style: TextStyle(
                              color: AppColors.textMuted,
                              fontSize: 12,
                            ),
