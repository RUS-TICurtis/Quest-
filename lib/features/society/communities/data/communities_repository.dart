...
class MockCommunitiesRepository implements CommunitiesRepository {
  final List<Community> _communities = [
    Community(
      ...
      description:
          'A community for Flutter developers of all skill levels building cross-platform experiences.',
      category: 'Technology',
      memberCount: 2340,
    ...
    Community(
      ...
      description:
          'Connecting early-stage founders, mentors, and investors to build impactful ventures.',
      category: 'Business',
      memberCount: 891,
    ...
    Community(
      ...
      name: 'Design Systems',
      description:
          'Typography, color, motion, design tokens, and component architecture.',
      category: 'Design',
      memberCount: 1204,
    ...
    Community(
      ...
      name: 'Local Run Club',
      description:
          'Weekly group runs in the city with morning coffee afterwards. All paces welcome.',
      category: 'Fitness',
      memberCount: 543,
    ...
    Community(
      ...
      description:
          'Deep dives into papers, autonomous agents, generative models, and LLM applications.',
      category: 'Technology',
      memberCount: 5120,
    ...
    Community(
      ...
      description:
          'Share urban photography, street perspectives, and join monthly photo walks.',
      category: 'Arts',
      memberCount: 376,
