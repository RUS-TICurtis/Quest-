  ...
  void initState() {
    ...
    _animController =
        AnimationController(
            vsync: this,
            duration: Duration(
              seconds: widget.durationSeconds > 0 ? widget.durationSeconds : 10,
            ),
          )
          ..addListener(() {
            setState(() {
              _currentSecond = (_animController.value * widget.durationSeconds)
                  .toInt();
            });
          })
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(
              color: widget.isMe ? Colors.white70 : context.colors.textMuted,
              fontSize: 12,
